  ...
  return (
    <div>
      ...
      <div className="divSoup">
        ...
        <div id="aws" className="bg-gray-400 p-4 rounded-3xl">
        ...
        <div id="vidoc" className="bg-gray-400 p-4 rounded-3xl">
        ...
        <div id="spacenews" className="bg-gray-400 p-4 rounded-3xl">
        ...
        <div id="ftm" className="bg-gray-400 p-4 rounded-3xl">
